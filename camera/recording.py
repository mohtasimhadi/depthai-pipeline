...
from configs import COLOR, MEDIAN, CALIBRATION_DATA_DIR, MAX_RANGE, CONFIDENCE_THRESHOLD, LRCHECK, MIN_RANGE, SUBPIXEL, EXTENDED
...
class Camera:
    ...
    def _load_calibration(self):
        ...
        self.intrinsics = calibration.getCameraIntrinsics(
            dai.CameraBoardSocket.RGB if COLOR else dai.CameraBoardSocket.RIGHT, 
